function Hero() {
  return (
    <section className="flex flex-col w-full gap-5 justify-center items-center min-h-screen">
      ...
      <p className=" max-w-2xl mx-auto leading-relaxed text-center text-base text-gray-500">
